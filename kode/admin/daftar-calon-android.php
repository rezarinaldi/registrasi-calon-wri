...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    $query = "SELECT * FROM pendaftar 
                INNER JOIN divisi ON pendaftar.iddivisi = divisi.iddivisi
            WHERE divisi.iddivisi = '1' LIMIT $dataAwal, $jumlahDataPerHalaman";
    $peserta = query($query);

    if (isset($_POST["cari"])) {
        $peserta = cariPendaftarAndroid($_POST["keyword"]);
    }
}
?>
                            ...
                            <div class="col">
                                <form class="form-inline d-flex flex-row-reverse" action="" method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm border-success" id="cari-pendaftar" placeholder="Cari Nama Pendaftar" name="keyword" autofocus autocomplete="off">
                                ...
                                <table class="table table-bordered table-sm">
                                    ...
                                    <?php foreach ($peserta as $dt) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="detil-calon-android.php?id=<?= $dt["idpendaftar"]; ?>"><button class="btn btn-info btn-sm" type="submit" name="detail-divisi"> <i class="fas fa-book"></i>
                                                        Rincian </button></a>
                                                <a href="hapus-calon-android.php?id=<?= $dt["idpendaftar"]; ?>">
