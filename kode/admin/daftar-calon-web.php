...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    $query = "SELECT * FROM pendaftar 
                INNER JOIN divisi ON pendaftar.iddivisi = divisi.iddivisi
            WHERE divisi.iddivisi = '2' LIMIT $dataAwal, $jumlahDataPerHalaman";
    $peserta = query($query);

    if (isset($_POST["cari"])) {
        $peserta = cariPendaftar($_POST["keyword"]);
    }
}
?>
                                ...
                                <table class="table table-bordered table-sm">
                                    ...
                                    <?php foreach ($peserta as $dt) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="detil-calon-web.php?id=<?= $dt["idpendaftar"]; ?>"><button class="btn btn-info btn-sm" type="submit" name="detail-divisi"> <i class="fas fa-book"></i>
                                                        Rincian </button></a>
                                                <a href="hapus-calon-web.php?id=<?= $dt["idpendaftar"]; ?>">
