...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    WHERE divisi.iddivisi = '2' and pendaftar.idpendaftar = '$id'")[0];
                            ...
                            <div class="row mt-2">
                                <div class="col d-flex flex-row-reverse">
                                    ...
                                    <form action="" method="post">
                                        <input type="hidden" class="form-control form-control-sm col-3" id="id-admin" name="id" value="<?= $peserta["idpendaftar"] ?>">
