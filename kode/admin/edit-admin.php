...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    $id = $_GET["id"];
    $admin = query("SELECT * FROM user WHERE iduser = $id ")[0];
    //var_dump($admin["iduser"]);
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Update Data Admin Pendaftaran WRI</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <form action="" method="post">
                                    <div class="form-group">
                                        <input type="hidden" class="form-control form-control-sm col-3" id="id-admin" name="id" value="<?= $admin["iduser"] ?>">
                                    </div>

                                    <div class=" form-group">
                                        <label for="exampleFormControlInput1">Nama : </label>
                                        <input type="text" class="form-control form-control-sm col-3" id="nama" value="<?= $admin["nama"] ?>" name="nama" required>
                                    </div>

                                    <div class=" form-group">
                                        <label for="exampleFormControlInput1">Username : </label>
                                        <input type="text" class="form-control form-control-sm col-3" id="username" value="<?= $admin["username"] ?>" name="username" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control form-control-sm col-3" id="re-enter-password" placeholder="Masukkan password lagi" name="password2" required>
                                    </div>

                                    <button class="btn btn-primary btn-sm" type="submit" name="update" id="update-admin">
                                        <i class="fa fa-pencil-alt"></i> Perbarui Admin</button>
                                    <a href="">
                                        <button type="reset" class="btn btn-danger btn-sm" name="batal" id="batal-divisi">
