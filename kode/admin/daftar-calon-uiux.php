...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    $query = "SELECT * FROM pendaftar 
                INNER JOIN divisi ON pendaftar.iddivisi = divisi.iddivisi
            WHERE divisi.iddivisi = '4' LIMIT $dataAwal, $jumlahDataPerHalaman";
            
    $peserta = query($query);

    if (isset($_POST["cari"])) {
        $peserta = cariPendaftarUI($_POST["keyword"]);
    }
}
?>
                            ...
                            <div class="col">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detil-calon-uiux.php?id=<?= $dt["idpendaftar"]; ?>"><button
                                                    class="btn btn-info btn-sm" type="submit" name="detail-divisi"> <i
                                                        class="fas fa-book"></i>
                                                    Rincian </button></a>
                                            <a href="hapus-calon-uiux.php?id=<?= $dt["idpendaftar"]; ?>">
