...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    $query = "SELECT * FROM user LIMIT $dataAwal, $jumlahDataPerHalaman";
    $data = query($query);

    if (isset($_POST["cari"])) {
        $data = cariAdmin($_POST["keyword"]);
    }
}
?>
                            ...
                            <div class="col">
                                ...
                                <form class="form-inline" action="" method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm border-success" id="cari-admin" placeholder="Cari data" name="keyword" autofocus autocomplete="off">
                                        <button type="submit" class="btn btn-success btn-sm ml-2" name="cari"> <i class="fa fa-search"></i>
                                            Cari</button>
                                    </div>
                                </form>
                            </div>
                            <div class="col text-right">
                                <a href="tambah-admin.php"><button class="btn btn-success btn-sm" name="tambah-admin" type="submit"> <i class="fa fa-plus"> </i> Tambah Admin </button></a>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col">
                                ...
                                <table class="table table-bordered table-sm">
                                    ...
                                    <?php foreach ($data as $admin) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit-admin.php?id=<?= $admin["iduser"]; ?>"><button class="btn btn-info btn-sm" type="submit" name="edit-admin"> <i class="fas fa-pencil-alt"></i> Edit </button> </a>
                                                <a href="hapus-admin.php?id=<?= $admin["iduser"]; ?>" onclick=" return confirm('Hapus user?');">
                                                    <button class="btn btn-danger btn-sm" type="submit" name="hapus-admin">
