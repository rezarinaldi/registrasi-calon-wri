...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    WHERE divisi.iddivisi = '1' AND pendaftar.idpendaftar = '$id'")[0];

    if (isset($_POST["tidakrekom"])) {
        if (updateStatusTidakRekom($_POST) > 0) {
            echo '<script>
                    alert("Data berhasil diupdate!");
                    document.location.href = "daftar-calon-android.php";
                </script>';
        } else {
            echo '<script>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Detail Data Pendaftar Divisi android</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mt-2">
                            <div class="col-5">
