...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    WHERE divisi.iddivisi = '4' AND pendaftar.idpendaftar = '$id'
    ")[0];
    ...
    if (isset($_POST["tidakrekom"])) {
        if (updateStatusTidakRekom($_POST) > 0) {
            echo '<script>
                    ...
                    document.location.href = "daftar-calon-uiux.php";
                </script>';
        } else {
            echo '<script>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Detail Data Pendaftar Divisi uiux</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mt-2">
                            <div class="col-5">
