...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    $jumlahData = count(query("SELECT * FROM divisi"));
    ...
    if (isset($_POST["cari-submit"])) {
        $divisi = cariDivisi($_POST["keyword"]);
    }
}
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form class="form-inline" action="" method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm border-success" id="cari-divisi" placeholder="Cari Divisi" name="keyword" autofocus autocomplete="off">
                                        <button type="submit" class="btn btn-success btn-sm ml-2" name="cari-submit"> <i class="fa fa-search"></i>
                                            Cari</button>
                                    </div>
                                </form>
                                <!-- end form search -->
                            ...
                            <div class="col text-right">
                                <a href="tambah-divisi.php"><button class="btn btn-success btn-sm" name="tambah-divisi" type="submit"> <i class="fa fa-plus"> </i> Tambah Divisi </button></a>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <th>Aksi</th>
                                    <?php $i = 1; ?>
                                    <?php foreach ($divisi as $dt) : ?>
                                        <tr>
                                            <td><?= $i  ?></td>
                                            <td><?= $dt["namadivisi"]  ?></td>
                                            <td>
                                                <a href="edit-divisi.php?id=<?= $dt["iddivisi"]; ?>">
                                                    <button class="btn btn-info btn-sm" type="submit" name="edit-divisi">
                                                        <i class="fas fa-pencil-alt"></i> Edit
                                                    </button>
                                                </a>
                                                <a href="hapus-divisi.php?id=<?= $dt["iddivisi"]; ?>" onclick=" return confirm('Hapus user?');">
