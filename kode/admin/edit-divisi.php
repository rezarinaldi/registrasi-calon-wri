...
if (empty($_SESSION['username']) or empty($_SESSION['password'])) {
    ...
    $id = $_GET["id"];
    $result = query("SELECT * FROM divisi WHERE iddivisi = $id ")[0];
    //var_dump($result["namadivisi"]);
                            ...
                            <div class="col">
                                <form action="" method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm col-3" id="id-divisi" value="<?= $result["iddivisi"] ?>" name="id" hidden>
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Nama Divisi : </label>
                                        <input type="text" class="form-control form-control-sm col-3" id="nama-divisi" value="<?= $result["namadivisi"] ?>" name="nama" required>
                                    </div>
                                    <button class="btn btn-success btn-sm" type="submit" name="update" id="update-divisi"> <i class="fa fa-pencil-alt"></i> Perbarui Divisi</button>
                                    <button class="btn btn-danger btn-sm" name="batal-divisi" id="batal-divisi" type="reset"> <i class="fa fa-times"></i>Batal</button>
                                </form>
                            </div>
                        </div>
                    </div>
