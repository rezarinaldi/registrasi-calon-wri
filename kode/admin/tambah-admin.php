                            ...
                            <div class="col">
                                <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm col-3" id="nama-admin" placeholder="Masukkan nama admin" name="nama" required>
                                    </div>
                                    ...
                                    <button class="btn btn-primary btn-sm" type="submit" name="submit" id="update-admin">
                                        <i class="fa fa-pencil-alt"></i> Tambah Admin</button>
                                    <a href="?hal=daftar-divisi"> <button type="reset" class="btn btn-danger btn-sm" name="batal-divisi" id="batal-divisi"> <i class="fa fa-times"></i>
                                            Batal</button></a>
                                </form>
                            </div>
                        </div>
